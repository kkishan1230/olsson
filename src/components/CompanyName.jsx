...
const CompanyName = () => {
  return (
    <div className="wave flex justify-center gap-8 max-w-[1920px] mx-auto mt-[64px] px-[60px] l:max-w-[960px] md:px-[30px] sm:mt-[20px] sm:px-[10px] sm:justify-center sm:gap-[30px]">
