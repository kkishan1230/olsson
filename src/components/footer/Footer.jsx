...
const Footer = () => {
  return (
    <div className="bg-[rgba(53,134,255,0.85)] relative footer">
      <div className="waves">
      ...
      <div className=" max-w-[1920px] px-[60px] mt-[150px] py-[64px] mx-auto flex justify-between md:flex-col md:gap-[40px] md:px-[30px] relative">
